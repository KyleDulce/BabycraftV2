...
public class MarriageRequest extends BcRequest {

	public MarriageRequest(UUID requester, UUID reciever) {
		super(requester, reciever);
		sendRequest("marry", "marriage", "/babycraft marry accept", "/babycraft marry deny");
	}
	...
	public void commit() {
		...
		if(agent.getBroadcastMarriageAnnoucement()) {
			...
			Debug.log(prequester.getName() + " and " + preciever.getName() + " got married");
		}
	}
